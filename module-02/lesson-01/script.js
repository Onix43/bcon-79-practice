...
function f1() {
  const res = document.querySelector(".i-1").value == 4;
...
function f3() {
  if (Number(input1.value) > Number(input2.value)) {
    out3.textContent = input1.value;
  } else {
    out3.textContent = input2.value;
  }
}
btn3.onclick = f3;
// Task 4.
...
function f4() {
  if (Number(input3.value) < 2008) {
    out4.textContent = 1;
  } else out4.textContent = 0;
}
btn4.onclick = f4;
...
const input4 = document.querySelector(".i-5");
...
const input5 = document.querySelector(".i-6");
const btn6 = document.querySelector(".b-6");
const out6 = document.querySelector(".out-6");
function f6() {
  if (Number(input5.value) % 2 === 0) {
    out6.textContent = "even";
  } else out6.textContent = "odd";
}
btn6.onclick = f6;
...
function f7() {
  out7.textContent = Number(input71.value) ** Number(input72.value);
}
...
function f8() {
  const choice = Number(select8.value);
  switch (choice) {
    case 1:
...
function f9() {
  Number(input9.value) >= 1 && Number(input9.value) <= 32
    ? (out9.textContent = 1)
    : Number(input9.value) >= 33 && Number(input9.value) <= 43
    ? (out9.textContent = 2)
    : Number(input9.value) >= 44 && Number(input9.value) <= 64
    ? (out9.textContent = 3)
    : (out9.textContent = 0);
}
...
function f12() {
  const res = input120.value;
  out12.textContent = typeof res;
}
...
btn13.onclick = () => {
  const res = input130.value;
  out13.textContent = typeof res;
};
...
// function f14() {
//   const expression = `${Number(input141.value)}${select143.value}${Number(
//     input142.value
//   )}`;
//   out14.textContent = eval(expression);
// }
function f14() {
  switch (select143.value) {
    case "+":
      out14.textContent = Number(input141.value) + Number(input142.value);
      break;
    case "-":
      out14.textContent = Number(input141.value) - Number(input142.value);
      break;
    case "*":
      ...
      break;
    case "/":
      if (Number(input142.value) === 0) {
        out14.textContent = "Не можна ділити на нуль!";
      } else
        out14.textContent = Number(input141.value) / Number(input142.value);
      break;
  }
...
function f15() {
  switch (select153.value) {
    case "&&":
      out15.textContent = select151.value && select152.value;
      break;
    case "||":
      out15.textContent = select151.value || select152.value;
      break;
